...
export const VerdictLogo: React.FC<VerdictLogoProps> = ({
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id="verdictShieldGrad" x1="16" y1="2" x2="16" y2="30" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#10b981" />
          <stop offset="100%" stopColor="#059669" />
        </linearGradient>
        <linearGradient id="verdictInnerGrad" x1="16" y1="7" x2="16" y2="25" gradientUnits="userSpaceOnUse">
